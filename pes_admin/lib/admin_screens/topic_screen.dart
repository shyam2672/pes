...
class _TopicScreenState extends State<TopicScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    topicCubit = BlocProvider.of<TopicCubit>(context);
    topicCubit!.loadTopics(user.token);
    return Scaffold(
                      ...
                      Expanded(
                        child: SmartRefresher(
                          ...
                          child: Container(
                            ...
                            child: ListView(
                              padding: EdgeInsets.zero,
                              children: topicCubit!.topics.map(
                                (e) {
                                  print(e);
                                  return TopicTile(topic: e);
                                },
                              ).toList(),
                            ),
                          ),
...
class TopicTile extends StatefulWidget {
  ...
  TopicTile({Key? key, required this.topic}) : super(key: key);
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            Text(
                              widget.topic.topicname.length > 30
                            ...
                            Expanded(
                              child: IconButton(
                                  onPressed: () {
                                    topicCubit!.deleteTopic(user.token,
                                        widget.topic.n_id);
                                    setState(() {
                                    });
                                  },
